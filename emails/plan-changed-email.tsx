...
export const PlanChangedEmail = ({ name, oldPlan, newPlan, nextBillingDate }: PlanChangedEmailProps) => {
  return (
    <Html>
      <Head />
      <Preview>Your Resume Optimizer Plan Has Been Updated</Preview>
      <Body style={main}>
        <Container style={container}>
          <Img
            ...
            style={logo}
          />
          <Heading style={heading}>Your Plan Has Been Updated</Heading>
          <Section style={section}>
            <Text style={text}>Hi {name},</Text>
            <Text style={text}>
              Your Resume Optimizer subscription has been updated from the {oldPlan} Plan to the {newPlan} Plan.
            </Text>
            <Text style={text}>Here's what you can expect with your new {newPlan} Plan:</Text>
            {newPlan === "Basic" ? (
              <ul style={list}>
